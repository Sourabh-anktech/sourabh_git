                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form" action="<?php echo SITE_ADMIN_HTTP_ROOT_PATH;?>admin_user_action.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name = "password" value = "<?php echo $password; ?>"><span class="error-message"><?php echo $passworderr; ?></span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name = "role">
									...
									{
									?>
                                    <option value="<?php echo $admin_role_data[$i]['id']; ?>" <?php if($role_id == $admin_role_data[$i]['id']) { ?>selected="selected"<?php } ?>><?php echo $admin_role_data[$i]['role_name'];?></option>
                                    <?php
									}
									?>
                                </select>
