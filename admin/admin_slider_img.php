...
$total_record = $sliderImgObj->countNoOfSliders(array());
...
$fields = array("id", "title", "content", "status");

$admin_slider_img_data = $sliderImgObj->getPaginationSlidersData(array(),$limit, $fields, $page_no);
...
?>
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-sliders"></i> Slider Images
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <a href="<?php echo SITE_ADMIN_HTTP_ROOT_PATH;?>admin_add_slider_img.php"><button type="button" class="btn btn-primary">Add new image</button></a>
                </div>
                <?php
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									...
									<?php
									$count=0;
									foreach($admin_slider_img_data as $data)
									{
										$count=$count+1;
									?>
                                    <tr>
                                        ...
                                        <td class="col-lg-2">
											<a href="<?php echo ADMIN_FILENAME_EDIT_SLIDER_IMAGE; ?>?id=<?php echo $data['id'];?>">Edit</a>&nbsp;
											<a href="<?php echo SITE_ADMIN_HTTP_ROOT_PATH;?>admin_slider_img_action.php?id=<?php echo $data['id'];?>&form_action=delete">Delete</a>
										</td>
                                    </tr>
                                    <?php
									}
