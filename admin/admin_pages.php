...
$total_record = $pageObj->countNoOfPages(array());
...
$admin_page_data = $pageObj->getPaginationPagesData(array(),$limit, $fields, $page_no);
...
?>
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <a href="<?php echo SITE_ADMIN_HTTP_ROOT_PATH;?>admin_add_page.php"><button type="button" class="btn btn-primary">Add new page</button></a>
                </div>
                <?php
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									...
									<?php
									$count=0;
									foreach($admin_page_data as $data)
									{
										$count=$count+1;
									?>
                                    <tr>
                                        ...
                                        <td>
											<a href="<?php echo SITE_ADMIN_HTTP_ROOT_PATH.ADMIN_FILENAME_EDIT_PAGE; ?>?page_id=<?php echo $data['id'];?>">Edit</a>&nbsp;
											<a href="<?php echo SITE_ADMIN_HTTP_ROOT_PATH;?>admin_page_action.php?page_id=<?php echo $data['id'];?>&form_action=delete">Delete</a>
										</td>
                                    </tr>
                                    <?php
									}
